...
class HitBox:
    ...
    @property
    def upper_right(self) -> IntTuple2:
        """
    ...
    @property
    def bottom_left(self) -> IntTuple2:
        """
    ...
    @property
    def bottom_right(self) -> IntTuple2:
        """
